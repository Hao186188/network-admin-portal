            ...
            <Card className="relative overflow-hidden group hover:shadow-2xl transition-all duration-300 border-border/50 hover:border-primary/30 active:scale-[0.98]">
              <CardContent className="p-4 md:p-6">
                <div className="flex items-center justify-between">
                  ...
                  <div
                    className={cn(
                      "w-10 h-10 md:w-14 md:h-14 rounded-xl md:rounded-2xl bg-gradient-to-r",
                      color,
                      "flex items-center justify-center shadow-lg group-hover:scale-110 transition-transform duration-300 flex-shrink-0",
                    )}
                  >
