// src/app/(routes)/about/components/FooterSection.tsx
// FOOTER SECTION - HOÀN CHỈNH
...
export function FooterSection({ socialLinks, quickLinks }: FooterSectionProps) {
  return (
    <VideoSection section="footer" className="border-t border-stroke/50">
      <footer className="relative w-full">
        <div className="absolute top-0 left-0 right-0 h-0.5 bg-gradient-to-r from-primary/50 via-secondary/50 to-accent/50 z-10" />
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8 lg:gap-12">
            ...
            >
              ...
              <p className="text-sm text-muted-foreground max-w-xs leading-relaxed">
                ...
                nơi chia sẻ tài liệu, bài giảng và kết nối cộng đồng.
              </p>
          ...
          >
            <div className="flex flex-col md:flex-row items-center justify-between gap-4">
              <div className="text-xs sm:text-sm text-muted-foreground text-center md:text-left">
                <span>© {new Date().getFullYear()} Mạng 3 Hub.</span>
