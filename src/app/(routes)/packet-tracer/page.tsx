// src/app/(routes)/packet-tracer/page.tsx
// Vai trò: Chia sẻ file Packet Tracer (.pkt) và hướng dẫn
...
const ptFiles = [
  {
    id: 1,
    title: "Mô hình mạng doanh nghiệp",
    description: "Mô hình mạng doanh nghiệp với VLAN, routing và NAT",
    type: "pkt",
    size: "5.2 MB",
    date: "2026-06-20",
    downloads: 56,
    views: 145,
    rating: 4.9,
    tags: ["Doanh nghiệp", "VLAN", "NAT"],
    author: "Nguyễn Ngọc Thanh",
  },
  {
    id: 2,
    title: "Lab OSPF với 4 Router",
    description: "Bài lab OSPF với multi-area và authentication",
    type: "pkt",
    size: "3.8 MB",
    date: "2026-06-18",
    downloads: 38,
    views: 98,
    rating: 4.6,
    tags: ["OSPF", "Multi-area", "Authentication"],
    author: "Nguyễn Ngọc Thanh",
  },
];

export default function PacketTracerPage() {
      ...
      <div className="max-w-7xl mx-auto space-y-8">
        ...
        >
          ...
          <p className="text-gray-500 dark:text-gray-400 mt-1">
            Chia sẻ file Packet Tracer (.pkt) và hướng dẫn
          </p>
        </motion.div>
        ...
        <div className="flex flex-col md:flex-row gap-4">
          <div className="relative flex-1">
            ...
            <Input
              placeholder="Tìm kiếm file Packet Tracer..."
              value={searchQuery}
