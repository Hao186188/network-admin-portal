// src/app/(routes)/documents/components/FileExplorer/Breadcrumbs.tsx
"use client";
...
export function Breadcrumbs({ items, onNavigate }: BreadcrumbsProps) {
  ...
  return (
    <div className="flex items-center gap-1 px-4 py-2.5 border-b border-white/5 bg-black/20 overflow-x-auto hide-scrollbar">
