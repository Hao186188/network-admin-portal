// src/app/(routes)/network-automation/page.tsx
// Vai trò: Chia sẻ tài liệu và script Network Automation
...
const automationResources = [
  {
    ...
    description: "Playbook Ansible cho tự động hóa mạng",
    type: "ansible",
    size: "4.5 KB",
    date: "2026-06-20",
    downloads: 56,
  ...
  {
    id: 2,
    title: "Python - Netmiko Script",
    description: "Script Python sử dụng Netmiko cho thiết bị Cisco",
    type: "python",
    size: "3.8 KB",
    date: "2026-06-18",
    downloads: 45,
    views: 89,
    rating: 4.7,
    tags: ["Python", "Netmiko", "Cisco"],
    author: "Nguyễn Ngọc Thanh",
  },
  {
    id: 3,
    title: "Terraform - Network Infrastructure",
    description: "Code Terraform cho infrastructure network",
    type: "terraform",
    size: "5.2 KB",
    date: "2026-06-15",
    downloads: 34,
      ...
      <div className="max-w-7xl mx-auto space-y-8">
        ...
        >
          ...
          <p className="text-gray-500 dark:text-gray-400 mt-1">
            Tài liệu và script tự động hóa mạng
          </p>
        </motion.div>
        ...
        <div className="flex flex-col md:flex-row gap-4">
          <div className="relative flex-1">
            ...
            <Input
              placeholder="Tìm kiếm tài nguyên Automation..."
              value={searchQuery}
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          {automationResources.map((resource) => (
            <motion.div
              key={resource.id}
              initial={{ opacity: 0, y: 20 }}
              animate={{ opacity: 1, y: 0 }}
