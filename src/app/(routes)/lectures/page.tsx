...
export default function LecturesPage() {
  ...
  const filteredLectures = filterLectures(lectures, filter);
  const stats = getStats(lectures);
  const uniqueTags = getUniqueTags(lectures);

  // toggleLike là function, gọi trực tiếp
